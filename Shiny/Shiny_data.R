...
met_shows <- left_join(met_shows, met_shows_city_stats_cn, by = c('city', 'state', 'country', 'continent')) %>%
  select(city_id, show_ID, show_date, city, state, country, continent, venue, tour_value, Other_acts_value, show_number) %>%
...
saveRDS(met_shows_city_stats, file="~/Projects/Metallica/Shiny/data/met_shows_city_stats_20241215.Rda")
saveRDS(met_shows, file="~/Projects/Metallica/Shiny/data/met_shows_20241215.Rda")
